#' Handcoded focus codestamp datasets for session "res2A"
#'
#' A list of wkFocus "datsets" of hand-coded work-focus codes by a one or more coders for session "res2A". Each dataset is a list of two elements: .$name is a charcter string giving the unique name described by the session ID ("res2A"), the code type ("focus"), the coding method ("hand"), the coder ID and a version ID for this coder, and the type of timed stamp in the datset ("cstamp"); .$data is a dataframe holding the codestamps, described below.
#'
